...
- **AI NPCs:** call the deployed **CryptoBuds API** (`/session`, `/npc/chat`, `/npc/:id/history`). Deploy API on Vercel/Fly + Neon Postgres (pgvector). OPENAI_API_KEY from AgilityOS.
